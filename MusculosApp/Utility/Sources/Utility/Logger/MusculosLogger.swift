...
public final class MusculosLogger {
  public enum LogCategory: String {
    case networking, coreData, ui, healthKit, recommendationEngine, decoderError, dataRepository, backgroundWorker, locationManager
  }
...
extension MusculosLogger {
  private static func constructLogMessage(
    error: Error? = nil,
    message: String,
    category: LogCategory,
    properties: [String: Any]
