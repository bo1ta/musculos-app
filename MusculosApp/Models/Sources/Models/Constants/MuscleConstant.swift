...
public enum MuscleConstant {
  ...
  public static func parseMuscleString(_ muscle: String) -> String {
    if let muscleName = MuscleConstant.MuscleName(rawValue: muscle) {
      ...
      MuscleConstant.MuscleName.cardio.rawValue
    }
  }
  ...
  public enum MuscleData {
    public static let muscles: [MuscleName: MuscleInfo] = [
      ...
      .cardio: MuscleInfo(
        id: 1,
        name: "Cardio",
        imageInfo: MuscleImageInfo(frontAnatomyIds: [6, 7, 10, 16], backAnatomyIds: [8, 7, 10])),
      ...
      .upperLegs: MuscleInfo(
        id: 8,
        name: "Upper Legs",
        imageInfo: MuscleImageInfo(frontAnatomyIds: [10, 15], backAnatomyIds: [8])),
