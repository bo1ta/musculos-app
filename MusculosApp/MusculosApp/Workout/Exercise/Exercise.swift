...
//    }
//    
//    init(id: Int, uuid: String, name: String, exerciseBase: Int, description: String?, created: String, category: Int, language: Int, license: Int, licenseAuthor: String?, musclesId: [Int], equipmentId: [Int]) {
//        self.id = id
//        self.uuid = uuid
//        self.name = name
